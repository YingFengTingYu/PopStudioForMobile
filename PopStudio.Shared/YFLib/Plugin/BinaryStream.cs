...
namespace PopStudio.Plugin
{
    ...
    public class BinaryStream : IDisposable
    {
        ...
        //校验数据
        public void IdByte(byte h, Endian _ = Endian.Null)
        {
            if (ReadUInt8() != h) throw new DataMismatchException();
        }
        ...
        public void IdSByte(sbyte h, Endian _ = Endian.Null)
        {
            if (ReadInt8() != h) throw new DataMismatchException();
        }

        public void IdInt8(sbyte h, Endian _ = Endian.Null)
        {
            if (ReadInt8() != h) throw new DataMismatchException();
        }
        ...
        {
            if (ReadInt16(endian) != h) throw new DataMismatchException();
        }

        public void IdUInt16(ushort h, Endian endian = Endian.Null)
        {
            if (ReadUInt16(endian) != h) throw new DataMismatchException();
        }

        public void IdShort(short h, Endian endian = Endian.Null)
        {
            if (ReadInt16(endian) != h) throw new DataMismatchException();
        }

        public void IdUShort(ushort h, Endian endian = Endian.Null)
        {
            if (ReadUInt16(endian) != h) throw new DataMismatchException();
        }
        ...
        {
            if (ReadInt32(endian) != h) throw new DataMismatchException();
        }

        public void IdUInt32(uint h, Endian endian = Endian.Null)
        {
            if (ReadUInt32(endian) != h) throw new DataMismatchException();
        }

        public void IdInt(int h, Endian endian = Endian.Null)
        {
            if (ReadInt32(endian) != h) throw new DataMismatchException();
        }

        public void IdUInt(uint h, Endian endian = Endian.Null)
        {
            if (ReadUInt32(endian) != h) throw new DataMismatchException();
        }

        public void IdInt64(long h, Endian endian = Endian.Null)
        {
            if (ReadInt64(endian) != h) throw new DataMismatchException();
        }

        public void IdUInt64(ulong h, Endian endian = Endian.Null)
        {
            if (ReadUInt64(endian) != h) throw new DataMismatchException();
        }

        public void IdLong(long h, Endian endian = Endian.Null)
        {
            if (ReadInt64(endian) != h) throw new DataMismatchException();
        }

        public void IdULong(ulong h, Endian endian = Endian.Null)
        {
            if (ReadUInt64(endian) != h) throw new DataMismatchException();
        }
        ...
        {
            if (ReadString(h.Length, endian) != h) throw new DataMismatchException();
        }
        ...
        public byte PeekUInt8(Endian _ = Endian.Null)
        {
            byte ans = ReadUInt8();
            Position--;
            return ans;
        ...
        public sbyte PeekSByte(Endian _ = Endian.Null)
        {
            sbyte ans = ReadInt8();
            Position--;
            return ans;
        ...
        public sbyte PeekInt8(Endian _ = Endian.Null)
        {
            sbyte ans = ReadInt8();
            Position--;
            return ans;
        ...
        public short PeekShort(Endian endian = Endian.Null)
        {
            short ans = ReadInt16(endian);
            Position -= 2;
            return ans;
        }

        public ushort PeekUShort(Endian endian = Endian.Null)
        {
        ...
        public short PeekInt16(Endian endian = Endian.Null)
        {
            short ans = ReadInt16(endian);
            Position -= 2;
            return ans;
        ...
        public int PeekThreeByte(Endian endian = Endian.Null)
        {
            int ans = ReadInt24(endian);
            Position -= 3;
            return ans;
        }

        public uint PeekUThreeByte(Endian endian = Endian.Null)
        {
            uint ans = ReadUInt24(endian);
            Position -= 3;
            return ans;
        }

        public int PeekInt24(Endian endian = Endian.Null)
        {
            int ans = ReadInt24(endian);
            Position -= 3;
            return ans;
        ...
        public uint PeekUInt24(Endian endian = Endian.Null)
        {
            uint ans = ReadUInt24(endian);
            Position -= 3;
            return ans;
        ...
        public int PeekInt(Endian endian = Endian.Null)
        {
        ...
        public uint PeekUInt(Endian endian = Endian.Null)
        {
            uint ans = ReadUInt32(endian);
            Position -= 4;
            return ans;
        }
        ...
        public uint PeekUInt32(Endian endian = Endian.Null)
        {
            uint ans = ReadUInt32(endian);
            Position -= 4;
            return ans;
        ...
        public long PeekLong(Endian endian = Endian.Null)
        {
            long ans = ReadInt64(endian);
            Position -= 8;
            return ans;
        }

        public ulong PeekULong(Endian endian = Endian.Null)
        {
            ulong ans = ReadUInt64(endian);
            Position -= 8;
            return ans;
        }

        public long PeekInt64(Endian endian = Endian.Null)
        {
            long ans = ReadInt64(endian);
            Position -= 8;
            return ans;
        ...
        public ulong PeekUInt64(Endian endian = Endian.Null)
        {
            ulong ans = ReadUInt64(endian);
            Position -= 8;
            return ans;
        ...
        public int PeekVarInt32(Endian _ = Endian.Null)
        {
            long pos = Position;
            int ans = ReadVarInt32();
            Position = pos;
            return ans;
        }

        public long PeekVarInt64(Endian _ = Endian.Null)
        {
            long pos = Position;
            long ans = ReadVarInt64();
            Position = pos;
            return ans;
        }

        public uint PeekUVarInt32(Endian _ = Endian.Null)
        {
            long pos = Position;
            uint ans = ReadUVarInt32();
            Position = pos;
            return ans;
        }

        public ulong PeekUVarInt64(Endian _ = Endian.Null)
        {
            long pos = Position;
            ulong ans = ReadUVarInt64();
            Position = pos;
            return ans;
        }

        public int PeekZigZag32(Endian _ = Endian.Null)
        {
            long pos = Position;
            int ans = ReadZigZag32();
            Position = pos;
            return ans;
        }

        public long PeekZigZag64(Endian _ = Endian.Null)
        {
            long pos = Position;
            long ans = ReadZigZag64();
            Position = pos;
            return ans;
        }

        public Half PeekHalf(Endian endian = Endian.Null) => PeekFloat16(endian);

        public Half PeekFloat16(Endian endian = Endian.Null)
        {
            Half ans = ReadFloat16(endian);
            Position -= 2;
            return ans;
        }

        public float PeekSingle(Endian endian = Endian.Null) => PeekFloat32(endian);

        public float PeekFloat32(Endian endian = Endian.Null)
        {
            float ans = ReadFloat32(endian);
            Position -= 4;
            return ans;
        }

        public double PeekDouble(Endian endian = Endian.Null) => PeekFloat64(endian);

        public double PeekFloat64(Endian endian = Endian.Null)
        {
            double ans = ReadFloat64(endian);
            Position -= 8;
            return ans;
        }

        public bool PeekBool(Endian _ = Endian.Null) => PeekBoolean();
        public bool PeekBoolean(Endian _ = Endian.Null)
        {
            bool ans = ReadBoolean();
            Position--;
            return ans;
        }
        public char PeekChar(Endian endian = Endian.Null)
        {
            char ans = ReadChar(endian);
            Position -= 2;
            return ans;
        }

        public byte[] PeekBytes(int count, Endian endian = Endian.Null)
        {
            byte[] ans = ReadBytes(count, endian);
            Position -= count;
            return ans;
        }
        ...
        public Half ReadHalf(Endian endian = Endian.Null) => ReadFloat16(endian);

        public unsafe Half ReadFloat16(Endian endian = Endian.Null)
        {
            uint num = ReadUInt16(endian);
            return *(Half*)&num;
        }
        ...
        public void WriteHalf(Half value, Endian endian = Endian.Null) => WriteFloat16(value, endian);

        public unsafe void WriteFloat16(Half value, Endian endian = Endian.Null)
        {
            uint num = *(uint*)&value;
            if (endian == Endian.Null) endian = Endian;
            if (endian == Endian.Big)
        ...
        public byte[] ToArray()
        {
            long nowPosition = BaseStream.Position;
            byte[] bytes;
            ...
            BaseStream.Position = nowPosition;
            return bytes;
        }
