...
namespace PopStudio.Reanim
{
    ...
    {
        public static void Encode(Reanim reanim, YFFile outFile, Func<object, int> func)
        {
            using (BinaryStream bs = new BinaryStream())
            {
                ...
                for (int i = 0; i < trackNum; i++)
                {
                    ...
                    {
                        ReanimTransform transform = track.transforms[j];
                        bs.WriteInt32((int)func(transform.i));
        ...
        public static Reanim Decode(YFFile inFile, Func<int, object> func)
        {
            using (BinaryStream bs = new BinaryStream())
            {
